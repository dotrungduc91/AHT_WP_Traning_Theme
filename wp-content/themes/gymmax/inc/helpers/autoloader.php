...
namespace GYMMAX_THEME\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( GYMMAX_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\GYMMAX_THEME\Inc\Helpers\autoloader' );
